...
class RegisteredAnimalFormVaccinations extends StatefulWidget {
  const RegisteredAnimalFormVaccinations({super.key});

  @override
  State<RegisteredAnimalFormVaccinations> createState() => _RegisteredAnimalFormVaccinationsState();
}

class _RegisteredAnimalFormVaccinationsState extends State<RegisteredAnimalFormVaccinations> {
  @override
