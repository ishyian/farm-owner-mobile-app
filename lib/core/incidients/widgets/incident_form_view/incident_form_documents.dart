...
class IncidentFormDocuments extends StatefulWidget {
  const IncidentFormDocuments({super.key});

  @override
  State<IncidentFormDocuments> createState() => _IncidentFormDocumentsState();
}

class _IncidentFormDocumentsState extends State<IncidentFormDocuments> {
  @override
  ...
  Row buildHeader(IncidentFormProvider provider) {
    return Row(
      children: [
        Text(
          "documents".tr(),
  ...
  Widget buildDocumentRow(IncidentFormProvider provider, int i) {
    return Container(
